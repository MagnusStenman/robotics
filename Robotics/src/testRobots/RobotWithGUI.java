...
public class RobotWithGUI {
	...
	private String host;
	private int port;
	private RobotWithGUI robot;
	private ObjectMapper mapper;
	private List<Map<String, Object>> mapList;
	private GUI gui;

	public RobotWithGUI(String host, int port) {
		this.host = host;
		this.port = port;
		this.robot = this;
	...
	public RobotWithGUI(String host, int port, String filePath) {
		this.host = host;
		this.port = port;
		this.robot = this;
