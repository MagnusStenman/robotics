...
public class RobotController {
    ...
    private final RobotCommunication robotComm;
    private Position goalPos;

    /**
     * Constructor for RobotController.
     *
     * @param host     communication IP-address or URL to MRDS
     * @param port     communication port to MRDS
     * @param filePath path to the JSON-file
     */
    public RobotController(String host, int port, String filePath) {
     ...
     *
     * @param robotLR LocalizationResponse for the robot
     * @param nextLR  LocalizationResponse for the next position on the path
     ...
     *
     * @param robotLR   the robots LocalizationResponse
     * @param currentCP the current carrotpoint
     * @param nextCP    the suggested next carrotpoint
     ...
     *
     * @param filePath path to the JSON path object
     * @return List<Map<String,Object>>
     * @throws JsonParseException
     * @throws JsonMappingException
     * @throws IOException
     */
    private List<Map<String, Object>> readFile(String filePath)
     ...
     * checking the distance between the robot and goal but also that at least
     ...
     *
     * @param robotLR the robots LocalizationResponse
     * @param nextCP  the next carrotpoint to aim for
     * @throws Exception
     */
     ...
     *
     * @param ddr   the current move command
     * @param angle current angularspeed
     ...
     *
     * @param args must be a filepath to a JSONfile in the right format
     */
    public static void main(String[] args) {
        RobotController robot;
        if (args.length > 0) {
            robot = new RobotController("http://127.0.0.1", 50000, args[0]);
        } else {
            robot = new RobotController("http://127.0.0.1", 50000,
