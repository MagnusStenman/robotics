...
public class time0159 {

	private String host;
	private int port;
	private time0159 robot;
	private ObjectMapper mapper;
	private List<Map<String, Object>> mapList;

	public time0159(String host, int port) {
		this.host = host;
		this.port = port;
		this.robot = this;
	...
	public time0159(String host, int port, String filePath) {
		this.host = host;
		this.port = port;
		this.robot = this;
	...
	public void start() throws Exception {
		...
		System.out.println(new SimpleDateFormat("MM:SS").format(System.currentTimeMillis() - time));
		// TESTCODE//
		/*
		 * DifferentialDriveRequest ddr = new DifferentialDriveRequest();
		 * 
